SELECT Country, KmSquared, ROUND(KmSquared/20761, 0) as 'WalesUnits', (Kmsquared % 20761) as 'AreaLeftOver'
CASE 
WHEN CAST(ROUND((KmSquared/20761), 0) as varchar(10)) < 1  THEN 'Smaller than Wales'
